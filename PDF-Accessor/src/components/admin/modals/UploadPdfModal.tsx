    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-lg p-6 md:p-8 animate-in zoom-in-95 duration-300 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={onSubmit} className="space-y-5">
          ...
          <button 
            type="submit" 
            className="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-3.5 rounded-xl font-bold mt-6 transition-colors flex items-center justify-center gap-2 shadow-lg shadow-emerald-200"
          >
